//دا  الاكسبشن اللى بترميه لما بيكون فيه خطا وطبعا بيكون شايل الايرور موديل اللى فى الملف السابق
import 'package:dio/dio.dart';
import 'package:myposts_clean_architecture/core/errors/error_model.dart';
